...
class Member(models.Model):
    ...
    def __str__(self):
        return self.user.username if self.user else "Unnamed Member"
...
class Loan(models.Model):
    ...
    interest_rate = models.DecimalField(max_digits=5, decimal_places=2, default=10.0) # Annual interest percentage
...
class LoanInstallment(models.Model):
    ...
    total_amount = models.DecimalField(max_digits=10, decimal_places=2) # EMI amount
...
class Document(models.Model):
    ...
    def __str__(self):
        username = self.member.user.username if self.member and self.member.user else "Unknown"
        return f"Document for {username}"


# ==========================================
# SIGNALS: Auto-generate Repayment Schedule & Notifications
# ==========================================
